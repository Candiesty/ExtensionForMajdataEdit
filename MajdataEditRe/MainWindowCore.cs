...
namespace MajdataEdit
{
    public partial class MainWindow : Window
    {
        ...
        //------------------------
        public static long captureTemp = 0x4000;    //截取缓冲区大小(应该够用了吧?)
        public static bool captureToSave = false;   //检测是否需要截取谱面
        public static double lastCaptureTime = 0.0; //指明截取所需开始时间
        public static int lastCapturePosition = 0;  //指明截取所需结束时间
        public static float startBpm = 0.0f;        //指示开始的bpm
        public static int startSignature = 0;       //开始的拍号
        ...
        void ReadEditorSetting()
        {
            ...
            AddGesture(editorSetting.QuickCaptureKey, "Capture");
